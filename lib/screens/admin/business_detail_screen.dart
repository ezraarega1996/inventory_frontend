                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (business.subscriptionEndsAt != null)
                              _buildInfoRow(
                                'Subscription Ends',
                                _formatDate(business.subscriptionEndsAt!),
                              ),
                            const SizedBox(height: 16),
                            Row(
                              children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildInfoRow(
                                'Users',
                                _stats['userCount']?.toString() ?? '0',
                              ),
                              _buildInfoRow(
                                'Items',
                                _stats['itemCount']?.toString() ?? '0',
                              ),
                              _buildInfoRow(
                                'Total Sales',
                                '${_stats['totalSales']?.toString() ?? '0'} ETB',
                              ),
                              _buildInfoRow(
                                'Sales Count',
                                _stats['salesCount']?.toString() ?? '0',
                              ),
                            ],
                          ),
                        ),
