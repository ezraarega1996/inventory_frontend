...
class _AvailableItemsScreenState extends State<AvailableItemsScreen> {
  ...
  Future<void> _calculateAvailableItems() async {
    final availableItemProvider = Provider.of<AvailableItemProvider>(context, listen: false);
    await availableItemProvider.calculateAvailableItems();
  }
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: CustomButton(
              onPressed: _calculateAvailableItems,
              text: 'Calculate Available Items',
              isLoading: availableItemProvider.isLoading,
            ),
          ),
          Expanded(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text('Price: \$${availableItem.soldPrice}'),
                              ],
                            ),
                          ),
                        );
